                ...
                <div class="row">
                        ...
                        <table class="table table-cart table-mobile">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="total-col">{{number_format($cart->price) * number_format($cart->qty)}} đ</td>
                    ...
                    <aside class="col-lg-3">
                        <div class="summary summary-cart">
                            ...
                            <a href="{{route('shop.checkout.index')}}" class="btn btn-outline-primary-2 btn-order btn-block">PROCEED TO CHECKOUT</a>
                        </div><!-- End .summary -->

                        <a href="{{route('shop.products.all')}}" class="btn btn-outline-dark-2 btn-block mb-3"><span>CONTINUE SHOPPING</span><i class="icon-refresh"></i></a>
                    </aside><!-- End .col-lg-3 -->
                </div><!-- End .row -->
            </div><!-- End .container -->
        </div><!-- End .cart -->
