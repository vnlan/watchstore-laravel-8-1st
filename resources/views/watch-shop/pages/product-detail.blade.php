                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            ...
                                            <a class="product-gallery-item " href="#" data-image="{{$image->image_path}}" data-zoom-image="{{$image->image_path}}">
                                                <img src="{{$image->image_path}}" alt="product cross">
                                            </a>
                                            @endforeach
...
<!-- 
                                    ...
                                    <div class="product-details-action">
                                        <a href="{{route('shop.cart.add', ['id' => $product->id])}}" class="btn-product btn-cart"><span>add to cart</span></a>
...
@section('shop-js')
<script src="{{asset('shop/assets/js/jquery.elevateZoom.min.js')}} "></script>
@endsection